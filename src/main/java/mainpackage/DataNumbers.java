...
public class DataNumbers {
    ...
    /**
     * Returns the score (without counting flush points) of unsuited 5-combo with identifier idx
     * @param idx
     * @return the score (without counting flush points) of unsuited 5-combo with identifier idx
     */

...
public class Ambitious {
    ...
    public static CribChoiceHeuri getChoiceF6(int[] cards, boolean myCrib) {
        ...
        for (int i = 0; i < 6; i++) {
            for (int j = i + 1; j < 6; j++) {
                ...
                float cribEval = Ambitious.averageCribScore(ridCards, chosenCards,prob2CribSameSuit);
                //float cribEval=0;
                if (!myCrib) {
                    cribEval *= -1;
                }
    ...
    /** Returns an array containing all possibilities of hand-flip and their exact value
     * 
     * @return an array containing all possibilities of hand-flip and their exact value
     */
     ...
     * @param unavail other four cards of hand (cannot be the flip or the two other cards of the crib)
     * @param probOfCrib2SameSuit probability that the two cards of the crib have the same suit
    ...
    /**
     * Returns the index of a general combination if idx==0, otherwise TODO explanations
    ...
    public static void bigShitt(boolean myCrib){
        int [] combId=new int[6];
        ...
        do{
            ...
            CribChoiceHeuri ricp=getChoiceF6(numbers, myCrib);
            int multicoef=nbPossOfCardSet(numbers);
            ricp.addTo(arrOfScorePairs,multicoef);
        ...
        Database.writeCribFile(arrOfScorePairs, myCrib);

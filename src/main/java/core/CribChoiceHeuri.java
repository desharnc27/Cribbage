...
public class CribChoiceHeuri {
     ...
     *
     * @param values array that contains all probability weights of pair of
     * cards to throw in the crib
     * @param unSuitedVal same that values but unsuited
     * @param multiCoeff a priori probability of the sixtuple the choice comes
     * from
     */
    ...
    /**
     * Returns true if this and c have the same 2 unsuited cards, false
     * otherwise.
     *
     * @return true if this and c have the same 2 unsuited cards, false
     * otherwise.
     */

 ...
 *
 * Each one is associated with a weight, which compares its relevancy to other
 * relevant choices.
 *
 * @author desharnc27
 */
public class CCHBunch {
    ...
    /**
     * Divides all weights of the this CCHBunch by a same coefficient such that
     * their sum becomes 1.0
     */
     ...
     *
     * @param i the index of the choice. Lower indexes are for averagely better
     * choices.
     ...
     * @param multicoef a multiplicative factor, which usually derives from the
     * likelihood of the unsuited 6-combo from which this CCHBunch was found.
     */

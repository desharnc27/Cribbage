...
public class DataForStatFiles {
    ...
    private static String REPORT_PATH = RootFinder.getRootPath() + "weightReports" + File.separator;
    ...
    /**
     * Translates a statistic 2D array formatted as unsuited. to a statistic 2D
     * array formatted as suited.
     *
     * @param src
     * @param dest
     */
    ...
    /**
     * Initialize static variables of this class. Usually called by
    ...
    public static void proceed() {
        ...
        REPORT_PATH = RootFinder.getRootPath() + "weightReports" + File.separator;
     ...
     * (score4) of all 4-combos (score1), and average average value of every
     * individual card.
     *
     * Executing this function is necessary for neither the user program nor the
     * cribstat generator. The relevancy of this function is also questionable
     * since it produces horribly large files.
     */
     ...
     *
     * @param selfCrib true if it's the statistics from the player who has the
     * crib, false otherwise
    ...
    /**
     * Prints an analysis of the numerical differences between each stat file
     * and its preceding file.
     *
     * @param selfCrib true if self stats are analyzed, false if opp stats are
     * analyzed
     */
     ...
     *
     * Note: it works by DivideAndConquer, to lower the risk of numerical
     * imprecision amplification.
     *
     * @param arr float array

 ...
 * what the opponent could discard. Then class UserDiscardDecisioning uses them
...
public class UnsuitedMeths {
    ...
    /**
     * Not supported yet. Should return an evaluation of the expected difference
     * between your peg performance and your opponent's one
     *

...
/**
 *
 * This class contains labels and methods for translating objects into their
...
public class DataForStrings {
    ...
    /**
     * Method to execute to fill the static arrays, must be run at the beginning
     * of any main.
     */
    ...
    /**
     * Prints a String representation of a hand (with specified flip) and its
     * score
     *
    ...
    /**
     * Returns a String representation a score average in a way that it will
     * align correctly.
     *
     * @param i useless parameter (was suppose to adjust the indent of d, not
     * working)
